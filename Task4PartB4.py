...
cost = CECost()
model = MLP(cost=cost)
sigmoidLayer1 = Sigmoid(inputDimensions=784, outputDimensions=100, rng=rng)
sigmoidLayer2 = Sigmoid(inputDimensions=100, outputDimensions=100, rng=rng)
sigmoidLayer3 = Sigmoid(inputDimensions=100, outputDimensions=100, rng=rng)
sigmoidLayer4 = Sigmoid(inputDimensions=100, outputDimensions=100, rng=rng)
sigmoidLayer5 = Sigmoid(inputDimensions=100, outputDimensions=100, rng=rng)
